...
import { calculateIncreaseZoomRatio, calculateDecreaseZoomRatio } from 'util/ZoomUtil';
 ...
 * Zoom In Ctrl Ratio
 */
export const ZoomInCtrlBreakPoints = [10, 20, 40, 80, 100, 200, 400, 800, 1600, ZoomData.maximum];

/**
 * Zoom out Ctrl Ratio
 */
export const ZoomOutCtrlBreakPoints = [1600, 800, 400, 200, 100, 80, 40, 20, ZoomData.minimum];
