...
// import { IWidgetPropValueData, ControlSubComponentCount } from 'models/widget/WidgetPropTypes';
// import CompositeModel from 'store/component/CompositeModel';
// import { checkPageModel, isWidgetsDeletable } from 'util/WidgetUtil';
...
// export const layoutWidgetTypeNames = [
...
//    */
//   @boundMethod
//   private insertWidget(ctx: AkronContext, props: NewInsertWidgetCommandProps) {
//     const newWidgetModel = this.newCreateNewWidgetModel(ctx, props.widgetTypeId, props.widgetType, props.widgetName) as
//       | WorkAreaModel
//       | NewWidgetModel
//       | undefined;
...
//    */
//   @boundMethod
//   private insertWidgetAt(ctx: AkronContext, props: NewInsertWidgetAtCommandProps) {
...
//    */
//   @boundMethod
//   private insertWidgetFragmentModel(ctx: AkronContext, props: NewInsertWidgetFragmentModelCommandProps) {
...
//     }
//   ) {
//     const { newWidgetModel, isClone, initializeProperties, libraryID, isPositioned, parentWidgetModel, widgetTypeID } =
//       args;
...
//             originCenterInfo.x +
//             (viewPortInfo.getBoundingClientRect().width + leftToolPaneWidth - rigthtToolPaneWidth) / 2 / zoomRatio;
//           const centerY =
...
//       this.appendSubComponentCommand(ctx, SystemComponentType.AccordionSummary, 'AccordionSummary', newWidgetModel);
...
//         this.appendSubComponentCommand(ctx, SystemComponentType.StepPrevButton, 'StepPrevButton', newWidgetModel);
//         this.appendSubComponentCommand(ctx, SystemComponentType.StepNextButton, 'StepNextButton', newWidgetModel);
//       }
//     }
...
//    */
//   @boundMethod
//   private getParentToInsert(ctx: AkronContext, curWidget: BaseWidgetModel, isGxProject: boolean) {
...
//    */
//   @boundMethod
//   public deleteWidget(ctx: AkronContext, props: NewDeleteWidgetCommandProps) {
...
//    */
//   @boundMethod
//   private resizingWidget(ctx: AkronContext, props: WidgetResizingCommandProps): void {
//     const widgetEditInfoContainer = ctx.getWidgetEditInfoContainer();
//     const command = ctx.getCommand();
//     const selectionContainer = ctx.getSelectionContainer();
...
//     const workAreaModel =
//       ctx.getSelectionContainer()?.getEditingNewWorkArea() ?? (ctx.getNewAppModel().getFirstChild() as WorkAreaModel);
...
//    */
//   @boundMethod
//   private resetWidgetContent(ctx: AkronContext, props: ResetWidgetContentCommandProps): void {
...
//    */
//   @boundMethod
//   private insertConditionalLayoutFrame(ctx: AkronContext, props: InsertConditionalLayoutFrameCommandProps) {
...
//    */
//   @boundMethod
//   private deleteConditionalLayoutFrame(ctx: AkronContext, props: DeleteConditionalLayoutFrameCommandProps) {
...
//    */
//   @boundMethod
//   private updateConditionalLayoutFrame(ctx: AkronContext, props: UpdateConditionalLayoutFrameCommandProps) {
